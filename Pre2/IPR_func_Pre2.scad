...
//z drive rods
	...
	translate([calZ_drive_rod_spacing,0,(calZ_drive_rod_L-calRod_part_T)/2])
		mZ_drive_rod(calZ_drive_rod_L);
//z guides
...
//y supports (run in x direction)
	translate([calZ_drive_rod_spacing/2,calVertex_spacing_y/2,0])
		rotate([0,90,0])mRod(calY_support_L);
	translate([calZ_drive_rod_spacing/2,-calVertex_spacing_y/2,0])
		rotate([0,90,0])mRod(calY_support_L);
	translate([calZ_drive_rod_spacing/2, calVertex_spacing_y/2+calY_support_to_lower_support_y, calY_support_to_lower_support_z])
		rotate([0,90,0])mRod(calY_support_L);
	translate([calZ_drive_rod_spacing/2, -calVertex_spacing_y/2-calY_support_to_lower_support_y, calY_support_to_lower_support_z])
		rotate([0,90,0])mRod(calY_support_L);
...
//x guides	
	for(i=[-calX_guide_rod_spacing/2,calX_guide_rod_spacing/2]){
		translate([calZ_drive_rod_spacing/2,i,(calZ_drive_rod_L-calRod_part_T)/2])
	...
	for(i=[-calZ_drive_rod_to_guide_rod_spacing+calRod_part_T,calZ_drive_rod_spacing+calZ_drive_rod_to_guide_rod_spacing-calRod_part_T]){
		translate([i,0,(calZ_drive_rod_L-calRod_part_T)/2-dnaRod_R*2])
...
for(i=[(calZ_drive_rod_spacing-calVertex_spacing_x)/2,(calZ_drive_rod_spacing+calVertex_spacing_x)/2]){
	*translate([i,0,calDelta_size/2*tan(30)+dnaRod_R*2])
	...
	translate([i,0,dnaRod_R*2])
		rotate([0,90,90])mRod(calDelta_rod_L);
	translate([i,0,calDelta_size/2*tan(30)+dnaRod_R*2])
		rotate([60,0,0])
