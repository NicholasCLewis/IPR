...
%hardware(three);
x_360guide_bearing(upper);
*xy_guide_bearing(right,lower,three);		//use this module to get x or y guides
...
module guide_bearing_mount_cuts(length,width,thickness){
	...
	translate([0,-calAxis_bearing_center_spacing/2,-dnaAxis_bearing_W/2+10])
